...
@pytest.fixture
def dummy_remote_storage_controller() -> remote_storage_controller:
...
def test_host_not_found(dummy_remote_storage_controller: remote_storage_controller) -> None:
    output = dummy_remote_storage_controller.get_remote_host("Non-Existent")
    output is None


def test_host_no_created_model_found(
    dummy_remote_storage_controller: remote_storage_controller,
) -> None:
